...
class BaseContact:
    def __init__(self, first_name, last_name, phone_number_priv, email):
        ...
        self.email = email
    def __str__ (self):
        return f'{self.first_name} {self.last_name} {self.last_name} {self.phone_number_priv} {self.email}'
    def contact (self):
        return (f'Wybieram numer {self.phone_number_priv} i dzwonię do {self.first_name} {self.last_name}')
    def workcontact(self):
        return (f'Wybieram numer {self.phone_number_work} i dzwonię do {self.first_name} {self.last_name}')
    @property
    ...
    #def create_contact(kind, how_many):
        ...
        for i in range(how_many):
            if kind == 'b':
                ...
                contact = BaseContact(first_name = faker.first_name(), last_name = faker.last_name(), phone_number_priv = faker.phone_number(), email = faker.email(), company = faker.company(), job = faker.job(), phone_number_work = faker.phone_number())
                contacts.append(contact)
